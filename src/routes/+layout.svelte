...
<svelte:head>
	...
	<meta name="twitter:creator" content="@SarkinMota_AMF" />

	<!-- Favicon -->
	<link rel="icon" href="/favicon.ico" />
</svelte:head>

<div class="flex justify-between p-8  flex-col md:flex-row items-center md:items-baseline">
	<a href="/" class="font-bold text-2xl flex items-baseline">
	  <span class="text-4xl">S</span>
	  <span>M</span>
	  <span>A</span>
	</a> 
	<h1 class="text-4xl font-bold text-center mb-8">Find Your Dream Car</h1>
	<div>
	  <div class="flex gap-4">
		{#each profile_links as profile}
		  <a href={profile.link} target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-blue-600">
			{#if profile.platform === 'instagram'}
			  <svg class="w-6 h-6" fill=" " viewBox="0 0 24 24" aria-hidden="true">
			...
			{#if profile.platform === 'x'}
			  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
				<path fill="#000" d="M10.488 14.651L15.25 21h7l-7.858-10.478L20.93 3h-2.65l-5.117 5.886L8.75 3h-7l7.51 10.015L2.32 21h2.65zM16.25 19L5.75 5h2l10.5 14z" />
			  </svg>
			{/if}
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white">Car Inventory</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white">Sell Your Car</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white">Financing Options</a></li>
        ...
        <!-- Car Categories -->
        <div>
          <h3 class="font-bold text-lg mb-4">Car Categories</h3>
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white">Hybrid Cars</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white">Sports Cars</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li class="flex items-start">
              ...
              <span class="text-gray-400">123 Car Avenue, Motor City, Abuja Nigeria</span>
            </li>
            <li class="flex items-center">
              <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
              </svg>
              <span class="text-gray-400">(+234) 9064923080</span>
            </li>
            <li class="flex items-center">
              <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
              </svg>
              <span class="text-gray-400">info@sarkinmotaauto.com</span>
            </li>
          </ul>
          
          <!-- Newsletter -->
          <div class="mt-6">
            <h4 class="font-semibold mb-2">Subscribe to Newsletter</h4>
            <div class="flex">
              <input type="email" placeholder="Your email" class="px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900" />
